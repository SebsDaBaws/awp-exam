...
export async function loader({request}) {
  ...
  // Sort posts by most likes descending
  const posts = await db.models.Post.find().populate("userid").sort({likes: -1});
            ...
            {sortedPosts.map((post) => {
              return (
                <li key={post._id} className="border-b border-slate-200">
                  ...
                  {/* Add username to the end of url */}
                  <NavLink
